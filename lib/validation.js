...
/**
 * Validation for quote Input Plugin
 *
 ...
 * @param {String|Bool} input.all.quote - value of input quote
 ...
 * @param {Object} [settings.all.quote] - settings of input quote {Object}
 *
 * @returns {Bool|String} true or a string with the text describing the error
 *
 * @module quoteValidation
 */

module.exports = function quoteValidation(input, settings) {
